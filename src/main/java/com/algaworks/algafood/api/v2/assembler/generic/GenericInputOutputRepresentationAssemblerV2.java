package com.algaworks.algafood.api.v2.assembler.generic;
...
@Getter
public abstract class GenericInputOutputRepresentationAssemblerV2<T, I, O extends RepresentationModel<O>, C> extends RepresentationModelAssemblerSupport<T, O> {
	...
	public GenericInputOutputRepresentationAssemblerV2(Class<C> controllerClass, Class<O> outputDtoClass) {
