...
public class CidadeController implements CidadeControllerOpenApi {
	...
	@GetMapping(produces = "application/vnd.algafood.v1+json")
	...
	@CheckSecurity.Cidades.PodeConsultar
	@GetMapping(path = "/{codCidade}", produces = "application/vnd.algafood.v1+json")
	...
	@PostMapping(produces = "application/vnd.algafood.v1+json")
	...
	@CheckSecurity.Cidades.PodeEditar
	@PutMapping(path = "/{codCidade}", produces = "application/vnd.algafood.v1+json")
