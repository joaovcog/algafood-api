...
public class CozinhaService {
	...
	public Cozinha buscarOuFalhar(Long codCozinha) {
		return cozinhaRepository.findById(codCozinha).orElseThrow(
				() -> new EntidadeNaoEncontradaException(String.format(MSG_COZINHA_NAO_ENCONTRADA, codCozinha)));
	}
	...
	public void excluir(Long codigo) {
		try {
			...
			throw new EntidadeNaoEncontradaException(String.format(MSG_COZINHA_NAO_ENCONTRADA, codigo));
